...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $(document).on('click', "#btn_view", function() {
            ...
            $("#dtypefield").val($(this).data("field_name"));
