                ...
                <div class="card">
                    <div class="card-header row">
                        <div class="col-sm-12 col-md-6">
                            <h4 class="card-title">Data Master Field</h4>
                        </div>
                        <div class="col-sm-12 col-md-6">
                            <a type="button" class="btn btn-primary btn-sm float-right" href="<?= base_url() ?>cms/field/create">
                                        ...
                                        <tbody>
                                            ...
                                            foreach ($field as $key) { ?>
                                                <tr>
                                                    ...
                                                    <td><?= $key->address; ?></td>
                                                    <td>
                                                        <a type="button" class="btn btn-warning btn-sm text-white" href="<?= base_url() ?>cms/field/edit/<?= $key->id ?>"><i class="fa fa-pen"></i></a>
...
<script type="text/javascript">
    function hapus(id) {
        ...
        if (konfirmasi == true) {
            window.location.href = '<?= base_url() ?>cms/field/delete/' + id;
        }
    }
</script>
