        ...
        <div class="row">
            <div class="col-sm-8 m-auto d-flex justify-content-center">
                <div>
                    ...
                    <?php if ($event->form == "" || $event->form == "default.docx") { ?>
                        <div class="row">
                            <div class="col-sm-6 m-auto">

                                <a target="_blank" href="<?= base_url('asset/form/event/' . $event->form_url) ?>" class="btn btn-secondary w-100"><i class="fa fa-download"></i> Formulir</a>
                            </div>
                        </div>
                    <?php } else { ?>
                        <div class="row">
                            <div class="col-sm-6 m-auto">
                                <a target="_blank" href="<?= base_url('asset/form/event/' . $event->form) ?>" class="btn btn-secondary w-100"><i class="fa fa-download"></i> Formulir</a>
                            </div>
                            <div class="col-sm-6 m-auto">
                                <a target="_blank" href="<?= $event->form_url ?>" class="btn btn-secondary w-100"><i class="fa fa-download"></i> Formulir via Google Drive</a>
                            </div>
                        </div>
                    <?php } ?>
                </div>
